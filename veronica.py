...
# Ler o CSV
df_veronica = pd.read_csv('veronica.csv')
semanas_veronica = df_veronica[['semana']].values  # 2D
matriculas_veronica = df_veronica['matriculas'].values  # 1D

# Dividir dados em treino e teste
X_train, X_test, y_train, y_test = train_test_split(semanas_veronica, matriculas_veronica, test_size=0.2, random_state=42)
...
meta = int(os.getenv("META_VERONICA"))
